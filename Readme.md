...
* #### *Функціональні вимоги реалізовані в додатку*
  ...
  * Доступна фільтрація як в розрізі як ресторанів-партнерів, так і в розрізі пропонованих страв.
  * Пошук страв доступний користувачу за назвою, категорією, вартістю, рейтингом, популярністю.
  * Реалізований міні-кошик, що дозволяє користувачу слідкувати за своїм замовленням не покидаючи сторінку з вибраними фільтрами, що дозволяє економити час користувача і створює найсприятливіші умови для комфортного і якісного замовлення.
...
База даних: Використовується документо-орієнтована система управління БД MongooDB для зберігання інформації про користувачів, ресторани, страви та замовлення, забезпечуючи ефективне та масштабоване управління даними.

### *Дизайн інтерфейсу*
---
Дизайн інтерфейсу "Eatly" розроблений з увагою до користувацького досвіду. Включає в себе чіткі макети сторінок, використання приємних кольорів та інтерактивності на сторінці та інтуїтивне розміщення елементів у веб-додатку.
...
Використання **React Router** для реалізації навігації в додатку та перехоплення URL, забезпечуючи коректний відображення компонентів на основі шляхів.
...
Використано **Netlify** для швидкого та простого розгортання додатку, забезпечення автоматичного вивантаження коду з GitHub, автоматичної побудову та CDN-розповсюдження для покращення швидкодії та доступності проекту.
...
---
Цей проект був справжньою колективною роботою, де кожен учасник доклав максимальних зусиль, знань. Кожен мав досвід роботи з новими завданнями, що потребували читання документації та використання нового досвіду і знань та часу. Дружня атмосфера, взаємодопомога і колективне вирішеня складних завдань, дали змогу в обмежений час підготувати максимально зручний і дружній до користувача додаток.
