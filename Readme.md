...
* **Анна Штендера:**
  ...
  * створення сторінки CheckoutPage з логікою збирання даних користувача і оформлення замовлення, автозаповнення форми для авторизованого користувача,
  ...
  * написаня серверної логіки для створення тимчасового token для відновлення паролю,
...
* **Дмитро Кудь:**
  ...
  * створено робочий компонент Search з перемиканням пошуку по ресторанам/стравам, автозаповленням та логікою пошуку,
  * створено робочий компонент Filter для фільтрації страв за категоріями, ціною, популярністю,
...
* **Роман Джавадов:**
  ...
  * створено компонент RestaurantItem,
  * створено перевикористовуваний компонент ListItem,
  * створено компонент SwiperBanner,
...
* **Юрій Городній:**
  * створено rfc форми реєстрації з валідацією введених даних,
...
* **Ярослав Грошев:**
  ...
  * налаштування instance для axios,
