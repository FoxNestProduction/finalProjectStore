  ...
  const questions = [
    {
      question: {
        ...
        ua: 'Скільки триває доставка?',
        pl: 'How long does delivery take?',
      },
      answer: {
        en: 'You Can Get Information By Contacting Our Support Team Have 24/7 Service.',
        ua: 'Ви можете отримати інформацію, зв’язавшись із нашою службою підтримки, яка працює цілодобово без вихідних.',
    ...
    },
    {
      ...
      answer: {
        ...
        ua: 'Наша служба доставки їжі дозволяє вам обирати страви з ресторанів через нашу платформу, розміщувати замовлення, здійснювати оплату та замовляти доставку їжі до зручного вам місця, забезпечуючи зручний сервіс.',
    ...
    },
    {
      question: {
        ...
        ua: 'Як працює ваша служба доставки їжі?',
      ...
      answer: {
        ...
        ua: 'Наша служба доставки їжі дозволяє замовляти страви з ресторанів через нашу платформу, і ми доставляємо замовлення до вашого до зручного для вас місця.',
    ...
    },
    {
      question: {
        ...
        ua: 'Які варіанти оплати ви приймаєте?',
      ...
      answer: {
        ...
        ua: 'Ми приймаємо різноманітні варіанти оплати, включаючи кредитні/дебетові картки, цифрові гаманці та готівку при доставці.',
    ...
    },
    {
      question: {
        ...
        ua: 'Чи пропонуєте ви знижки або акції?',
      ...
      answer: {
        ...
        ua: 'Так, ми часто пропонуємо знижки та акції на вибрані ресторани та пункти меню, щоб заощадити кошти для наших клієнтів.',
